...
![](makeMiscFigures_files/figure-markdown_github-ascii_identifiers/peaks-1.png)

``` r
ggsave("../results/resPeaks.pdf", width = 105, height = 50, unit = "mm", useDingbats = F)
```

![](makeMiscFigures_files/figure-markdown_github-ascii_identifiers/peaks-2.png)
...
![](makeMiscFigures_files/figure-markdown_github-ascii_identifiers/libraryDistro-1.png)
...
![](makeMiscFigures_files/figure-markdown_github-ascii_identifiers/libraryDistro-2.png)![](makeMiscFigures_files/figure-markdown_github-ascii_identifiers/libraryDistro-3.png)
