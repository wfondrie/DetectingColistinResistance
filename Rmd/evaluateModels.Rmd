...
abPrior$cond <- labsAb
abPrior$cond <- fct_rev(fct_relevel(as.factor(abPrior$cond), labsAb))
...
kpPrior$cond <- labsKp
kpPrior$cond <- fct_rev(fct_relevel(as.factor(kpPrior$cond), labsKp))
...
ggsave("../results/mixturePRCurves.pdf", width = 105, height = 80, units = "mm", useDingbats = F)
...
ggsave("../results/mixtureROCCurves.pdf", width = 105, height = 80, units = "mm", useDingbats = F)
...
ggsave("../results/mixedCurvesAUCPlot.pdf", width = 105, height = 100, units = "mm", useDingbats = F)
```
